...
class DevasysI2C {
    ...
    ReadI2C(devAddr, numOfBytes) {
        ...
        console.log("READ  [0x" + devAddr.toString(16).toUpperCase() + "]: " + this.ToHexString(arr_sliced));
        return arr_sliced;
    }
    WriteI2C(devAddr, data) {
        ...
        console.log("WRITE [0x" + devAddr.toString(16).toUpperCase() + "]: " + this.ToHexString(data));
    }
    Open() {
